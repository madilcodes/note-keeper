                ...
                <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link bg-success text-light" title="login page" id="ex1-tab-1" data-mdb-toggle="pill"
                      href="../Agent/user.php" role="tab" target="_blank" aria-controls="ex1-pills-1" aria-selected="true">Sign
                      In</a>
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link bg-dark text-light" title="Contact form" id="ex1-tab-1" data-mdb-toggle="pill"
                      href="../Customer/contact_form.php" role="tab" target="_blank" aria-controls="ex1-pills-1"
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link bg-success text-light" title="Order Coffee" id="ex1-tab-1" data-mdb-toggle="pill"
                      href="../Customer/coffee.php" role="tab" target="_self" aria-controls="ex1-pills-1" aria-selected="true">Order
                      Coffee</a>
                  </li>
                  ...
                  <li class="nav-item" role="presentation">
                    <a class="nav-link bg-warning text-dark" title="Shopping ,Customer panel" id="ex1-tab-1"
                      data-mdb-toggle="pill" href="/note-keeper/Customer/customer_panel.php" role="tab"
          ...
          <div class="col-md-4 mb-5">
            <div class="card">
              <div class="card-body  bg-info text-center ">
                <a class="btn btn text-dark" href="/note-keeper/Customer/orders_details.php" target="_blank"
