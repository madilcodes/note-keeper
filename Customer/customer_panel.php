  ...
  <script>
    ...
    function confirmDelete(userId) {
      if (confirm("Are you sure to Cancel this Order?")) {
        ...
        window.location.href = 'delete_order.php?order_id=' + userId;
      } else {
    ...
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center">
        ...
        if (!isset($_SESSION['email'])) {
          ...
          ?>
          <a type="button" class="btn btn-light px-3 me-2" href='.././Customer/customer_login.php'>
            Login
          </a>&nbsp;&nbsp;
          <a type="button" class="btn btn-light me-3" href='.././Customer/customer_registration.php'>
            Sign up for free
          </a>
          <?php
        }
